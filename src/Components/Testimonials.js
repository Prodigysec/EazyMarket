      ...
      <div className="row d-flex justify-content-center">
        <div className="col-md-10 col-xl-8 text-center">
          ...
          <p className="mb-4 pb-2 mb-md-5 pb-md-0">
            Hear what some of our customers have to say about our exceptional service and wide range of products.
            You can also let us know what you think by filling in the review <a href="https://www.google.com" style={{ textDecoration: 'none', color: 'green' }}>here</a>.
          </p>
        </div>
      </div>
      ...
      <div className="row text-center d-flex align-items-stretch">
        <div className="col-md-4 mb-5 mb-md-0 d-flex align-items-stretch">
          <div className="card testimonial-card">
            ...
            <div className="card-body">
              <h4 className="mb-4" style={{ color: "green", fontWeight: "bold", fontFamily: "Roboto" }}>Michael Kamau</h4>
              <hr />
              <p className="dark-grey-text mt-4">
                <i className="fas fa-quote-left pe-2"></i>My favorite online store, the goods always arrive on time
        ...
        <div className="col-md-4 mb-5 mb-md-0 d-flex align-items-stretch">
          <div className="card testimonial-card">
            ...
            <div className="card-body">
              <h4 className="mb-4" style={{ color: "green", fontWeight: "bold", fontFamily: "Helvetica" }}>Jame Onyango</h4>
              <hr />
              <p className="dark-grey-text mt-4">
        ...
        <div className="col-md-4 mb-0 d-flex align-items-stretch">
          <div className="card testimonial-card">
            ...
            <div className="card-body">
              <h4 className="mb-4" style={{ color: "green", fontWeight: "bold", fontFamily: "Helvetica" }}>Ojoo Hamilton</h4>
              <hr />
              <p className="dark-grey-text mt-4">
                ...
                places I don't know. It's just like shopping in a mall without all the walking.
              </p>
            </div>
          </div>
        </div>
